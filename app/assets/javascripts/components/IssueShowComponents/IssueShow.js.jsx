  ...
  render: function(){
    return (
      <div className="issue_show">
        ...
        < IssueHeader issue={this.props.issue} category_name={this.props.category_name} current_user_watching={this.props.current_user_watching} current_user_id={this.props.current_user_id} upvotes={this.props.upvotes} current_user_upvoted={this.props.current_user_upvoted} />
