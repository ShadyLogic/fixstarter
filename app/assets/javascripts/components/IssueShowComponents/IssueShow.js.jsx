  ...
  render: function(){
    return (
      <div className="issue_show">
        ...
        < IssueHeader issue={this.props.issue} categories={this.props.categories} current_user_watching={this.props.current_user_watching} current_user_id={this.props.current_user_id} />
